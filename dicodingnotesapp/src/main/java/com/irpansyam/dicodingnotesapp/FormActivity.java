package com.irpansyam.dicodingnotesapp;
...
import com.irpansyam.dicodingnotesapp.entity.NoteItem;

import java.text.DateFormat;
import java.text.SimpleDateFormat;
import java.util.Date;

import static com.irpansyam.dicodingnotesapp.db.DatabaseContract.CONTENT_URI;
...
public class FormActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        if (v.getId() == R.id.btn_submit){
            ...
            if (!isEmptyField){
                ...
                if (isUpdate){
                    ...
                    Toast.makeText(this, "Satu catatan berhaasil diinputkan", Toast.LENGTH_SHORT).show();
                }
                finish();
            }
        }
    ...
    private  void showDeleteAlertDialog(){
        String dialogMessage = "Apakah anda yakin akan ingin menghapus item ini ?";
